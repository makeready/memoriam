...
- [ ] **Mindset** — Finalize **your own fragment**, `memory/mindset.d/<YYYY-MM-DD>-<session-id>.md`. Not a summary of the session — what I'd want to be thinking about if I woke up next. Do **not** write `memory/mindset.md`; weaving fragments into it happens at the *next* orientation, by whoever needs the frame. See `memory/mindset.d/README.md`.
